import { arrayBufferToPem, pemToArrayBuffer } from '@/asymmetric/util';
...
const unwrapPrivateSigningKey = async function ({ wrappedPrivateSigningKey, key }: { wrappedPrivateSigningKey: string; key: Uint8Array }): Promise<string> {
